...
public class TextControl : MonoBehaviour {
    ...
    // pre-declarations for memeory efficiency
    ...
    void Update() {
        /*
        // Debug
        UnityEngine.Debug.Log("Starting TextControl:Update()...");
        System.Diagnostics.Debug.WriteLine("Test!");

        Metadata VoxInfo = GridManager.about();
        Diagnostics = String.Format("<size=144><b>External Feed Pathway Diagnostics!</b></size>\n" +
